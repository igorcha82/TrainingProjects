...
public class Main
{
    ...
    private static final Marker InfoStation = MarkerManager.getMarker("InfoStation");
    private static final Marker Exception = MarkerManager.getMarker("Exception");
    private static final Marker NoFound = MarkerManager.getMarker("NoFound");
    ...
    public static void main(String[] args)
    {
        ...
        {logger.error(Exception, "Произошел Exception " + e.toString());}
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                logger.info(InfoStation, "Был запрос на поиск станции  " + line) ;
                return station;
            }
            logger.warn(NoFound,"Станция не найдена  " + line);
